...
public class WithdrawPanel extends JPanel implements ActionListener{
	...
	public WithdrawPanel(BankSystem bs) {
		...
		userInfo = new JLabel("환영합니다");
		userInfo.setFont(new Font("나눔고딕", Font.BOLD, 15));
		userInfo.setBounds(243, 27, 248, 15);
		add(userInfo);

		timeInfo = new JLabel("시간 출력");
		timeInfo.setFont(new Font("나눔고딕", Font.BOLD, 15));
		timeInfo.setBounds(245, 463, 229, 26);
		add(timeInfo);

		checkButton = new JButton("확인");
		checkButton.setFont(new Font("굴림", Font.BOLD, 13));
